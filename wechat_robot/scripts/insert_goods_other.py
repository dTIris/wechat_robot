""" 
游戏-商品入库脚本
执行命令: python -m wechat_robot.scripts.insert_goods_other -file goods_other.txt --log
"""
...
logger = logging.getLogger("GoodsUpdateByFile")


class GoodsUpdateByFile(BaseScript):
    """-"""
...
if __name__ == '__main__':
    ...
    task = asyncio.ensure_future(GoodsUpdateByFile("GoodsUpdateByFile").run())
